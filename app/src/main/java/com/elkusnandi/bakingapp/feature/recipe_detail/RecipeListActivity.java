...
//      RecipeDetailFragment fragment = new RecipeDetailFragment();// TODO: (QUESTION) So this is generated by master detail flow and it is not using factory pattern. Which is the best practise of it? what the adcantage and disadvantages of using factory method?
    ...
    public class SimpleItemRecyclerViewAdapter
        ...
        public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
            if (position == 0) {
                ...
                holderIngredients.mContentView.setText("Recipe Ingeredients");
